...
--
-- Host: localhost:3306
-- Generation Time: Dec 14, 2025 at 09:31 AM
...
(1, 2, 'neko neko', '0369353309', 'tan ky tan quy', 0, '2025-12-14 09:20:23', '2025-12-14 09:20:23');
...
INSERT INTO `comments` (`id`, `user_id`, `content`, `rating`, `id_product`, `commentable_type`, `created_at`, `updated_at`) VALUES
(6, 1, 'sản phẩm tốt', 4, 1, 'product', '2025-12-13 18:49:18', '2025-12-13 19:33:35'),
(11, 1, 'Sản phẩm rất đẹp, giao hàng nhanh, sẽ ủng hộ shop tiếp!', 5, 1, 'product', '2025-12-13 15:00:20', '2025-12-13 19:33:38'),
(12, 1, 'Chất lượng tạm ổn trong tầm giá, nhưng đóng gói hơi sơ sài.', 3, 6, 'product', '2025-12-13 15:00:20', '2025-12-13 19:33:41'),
(13, 2, 'Hàng bị lỗi nhẹ ở viền, shop hỗ trợ đổi trả nhiệt tình.', 4, 6, 'product', '2025-12-13 15:00:20', '2025-12-13 19:33:44'),
(14, 2, 'Không giống như hình ảnh quảng cáo, thất vọng.', 1, 6, 'product', '2025-12-13 15:00:20', '2025-12-13 19:33:46'),
(15, 3, 'Dùng được 1 tuần thấy khá ổn, chưa thấy lỗi gì.', 5, 6, 'product', '2025-12-13 15:00:20', '2025-12-13 19:33:48'),
(16, 1, 'sp tốt', 4, 6, 'product', '2025-12-13 19:07:10', '2025-12-13 19:33:49'),
(17, 1, 'sp này cũng tốt', 4, 7, 'product', '2025-12-13 20:04:47', '2025-12-13 20:04:47'),
(18, 1, 'ok sp rất tốt', 5, 6, 'product', '2025-12-14 09:22:33', '2025-12-14 09:22:33');
...
(6, 1, 4500000.00, 'tan ky tan quy12', '0909123456', 'pending', 1, 1, NULL, '2025-12-13 20:04:25', '2025-12-13 20:04:25');
...
(4, 6, 7, 1, 4500000.00, '2025-12-13 20:04:25', '2025-12-13 20:04:25');
...
(1, 'Khách Hàng A', 'khachhang_a@gmail.com', '$2y$10$kql0.dN1kFrSLFOwb2jhM.gWKl.Ey1cUzhIO2AWplOhh51Es1gCRK', 'customer', '0909123456', '2025-11-10 08:58:18', '2025-12-13 21:45:26'),
(2, 'neko neko1', 'necon12398@gmail.com', '$2y$10$xOe6TBXCmQM7tEnXnyEOIuR2.VhvYkyM.ykXulHZ7O9Mkr38IvZ82', 'customer', '0346673889', '2025-11-27 16:27:50', '2025-12-13 21:49:51'),
...
ALTER TABLE `comments`
  ...
  ADD CONSTRAINT `fk_comments_id_product` FOREIGN KEY (`id_product`) REFERENCES `products` (`id`) ON DELETE CASCADE;

        ...
        <div class="product-details-box">
            ...
            <form id="addToCartForm" action="<?= BASE_URL ?>index.php/cart/add" method="POST">
                ...
                <div class="action-group">
                    ...
                    <button type="submit" name="add_to_cart" value="1" class="cta-btn secondary" id="btnAddToCart">Thêm vào giỏ</button>
                </div>
            </form>
    ...
    <section class="product-info-grid scroll-reveal">
        ...
        <div class="specs-box">
            ...
            <table class="specs-table">
                <tr><td>Thương hiệu: Zero Watch</td></tr>
                <tr><td>Bảo hành: 2 Năm chính hãng</td></tr>
                <tr><td>Chống nước: 5 ATM</td></tr>
            </table>
        </div>
    </section>
</section>
...
<script>
  ...
  function processData(list) {
    ...
    list.forEach(item => {
      ...
      if (!groups[cName]) groups[cName] = { colorName: cName, colorCode: colorHexMap[cName] || '#ccc', images: [], variants: [] };

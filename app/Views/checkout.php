    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        <div class="order-summary-wrapper">
            ...
            <div class="order-list"
                style="margin-bottom: 20px; max-height: 300px; overflow-y: auto; border-bottom: 1px dashed #eee;">
                <?php if (!empty($cartItems)): ?>
                    <?php foreach ($cartItems as $item): ?>
                        <div class="summary-detail-row"
                            style="justify-content: flex-start; gap: 10px; padding-bottom: 10px; margin-bottom: 10px;">
                            <!-- Ảnh nhỏ -->
                            <img src="<?= $item['image'] ?>"
                                ...
                                <div style="font-size: 0.8rem; color: #666;">
                                    ...
                                    <?php if (!empty($item['variant_meta'])): ?>
                                        <br><span style="font-size: 0.75rem; color: #999;">
                                            <?= htmlspecialchars($item['variant_meta']['size'] ?? '') ?> -
                                            <?= htmlspecialchars($item['variant_meta']['color'] ?? '') ?>
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
            ...
            <div class="summary-detail-row">
                ...
                <span
                    class="value"><?= ($shipping > 0) ? number_format($shipping, 0, ',', '.') . 'đ' : 'Miễn phí' ?></span>
            </div>
            ...
            <!-- Nút Đặt hàng -->
            <button type="submit" form="checkout-form" class="btn-place-order" style="margin-top: 20px;">XÁC NHẬN ĐẶT
                HÀNG</button>
